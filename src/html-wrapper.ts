...
export interface PreviewHtmlArgs {
  rendered: string;
  seed: number;
  filename: string;
  error?: string;
...
export function wrapPreviewHtml(args: PreviewHtmlArgs): string {
...
export function wrapErrorHtml(message: string, seed: number): string {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
